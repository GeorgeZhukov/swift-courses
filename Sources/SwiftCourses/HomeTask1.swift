...
public class HomeTask1: HometaskBase {
  ...
  func task2() -> String {
    ...
    return
      "Мой возраст \(myAge) лет. Через 10 лет, мне будет \(myAgeInTenYears) лет, с момента моего рождения пройдет \(daysPassed) дней."
  }
  ...
  func task3() -> String {
    ...
    return
      "Катеты: AB = \(cathetusAB), CB = \(cathetusCB), Вычесленная гипотинуза: CA = \(hypotenuseCA)"
  }
